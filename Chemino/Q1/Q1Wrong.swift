...
struct Q1Wrong: View {
    ...
    var body: some View {
        //Q1Correct(pointsCounter: $pointsCounter)
    ...
    */
            ...
            VStack {
                ...
                NavigationLink("try again", destination: Q1View_old(pointsCounter: $pointsCounter), isActive: $Q1go)
...
struct Q1Wrong_Previews: PreviewProvider {
    @State static var pointsCounter = 0
    
    static var previews: some View {
        return Q1Wrong(pointsCounter: $pointsCounter)
    }
}
